          ...
          <div className="card info-card sales-card">
            <div className="filter">
              <a className="icon" href="#" data-bs-toggle="dropdown">
                <i className="bi bi-three-dots color-app2"></i>
              </a>
            ...
            <div className="card-body">
              ...
              <div className="d-flex align-items-center">
                <div className="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  <i className="bi bi-clock-history color-app2"></i>
                </div>
                <div className="ps-3">
                  <h6>{jumlahProses}</h6>
                  <span className="text-success small pt-1 fw-bold"><b className="color-app2">Postingan</b></span>{" "}
        ...
        <div className="col-xxl-4 col-md-6">
          <div className="card info-card sales-card">
            ...
            <div className="card-body">
              ...
              <div className="d-flex align-items-center">
                <div className="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  <i className="bi bi-clipboard-check color-app2"></i>
                </div>
                <div className="ps-3">
        ...
        <div className="col-xxl-4 col-md-6">
          <div className="card info-card sales-card">
            ...
            <div className="card-body">
              ...
              <div className="d-flex align-items-center">
                <div className="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  <i className="bi bi-clipboard-x color-app2"></i>
                </div>
                <div className="ps-3">
                  <h6>{jumlahDitolak}</h6>
                  <span className="text-success small pt-1 fw-bold"><b className="color-app2">Postingan</b></span>{" "}
      ...
      <section>
        <div className="row">
          ...
          <div className="col-xxl-4 col-md-4">
            <div className="card">
            {/* <div className="filter">
              <a className="icon" href="#" data-bs-toggle="dropdown"><i className="bi bi-three-dots color-app"></i></a>
                  ...
                  if (status === "draf") {
                    return (
                      <div key={index} className="activity-item d-flex">
                        ...
                        <i className="bi bi-circle-fill activity-badge text-success align-self-start color-app"></i>
                    ...
                    return (
                      <div key={index} className="activity-item d-flex">
                        <div className="activite-label">{timeAgoText}</div>
                        <i className="bi bi-circle-fill activity-badge text-danger align-self-start color-app"></i>
                        <div className="activity-content">
